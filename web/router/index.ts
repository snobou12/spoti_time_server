...
router.post("/getUserCategoryByUserId",authMiddleware,UserController.getUserCategoryByUserId);
router.post("/updateUserCategory",authMiddleware,UserController.updateUserCategory);
...
router.post("/switchFeaturePromocode",authMiddleware,PromocodesController.switchFeaturePromocode);
